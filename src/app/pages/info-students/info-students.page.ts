...
import { InfoStudents } from '../../@core/data/models/info_students_tercero';
...
@Component({
  ...
  templateUrl: './info-students.page.html',
  styleUrls: ['./info-students.page.scss'],
})
export class InfoStudentsPage implements OnInit {
  ...
  constructor(
    ...
    this.selectedData = new InfoStudents();
