export const environment = {
  ...
  INFO_COMPLEMENTARIA_IDS: {
    ...
    EN_LA_ACTUALIDAD_TIENE_PERSONAS_A_CARGO: 1881,
    CON_MOTIVO_DE_SU_PRXIMA_GRADUACIN_CUL_ES_SU_NIVEL_DE_EXPECTATIVA_E_INCERTIDUMBRE_FRENTE_A_LA: 1882,
    QUE_ASPECTOS_O_COMPETENCIAS_LE_GENERAN_INSEGURIDAD_FRENTE_A_SU_PERFIL_PROFESIONAL: 1883,
    DESEA_OBTENER_INFORMACIN_DEL_SEMINARIO_DE_EMPLEABILIDAD: 1884,
    SELECCIONE_LA_FACULTAD_DE_LA_QUE_ES_EGRESADO: 1885,
    SELECCIONE_SU_CARRERA: 1886,
    INDIQU_LA_FECHA_PROGRAMADA_O_ESTIMADA_DE_SU_GRADUACIN: 1887,
    DESPUS_DE_SU_GRADUACIN_CUL_DE_LAS_SIGUIENTES_OPCIONES_DE_FORMACIN_HA_PENSADO_REALIZAR: 1888,
    TIENE_CONOCIMIENTO_DE_LOS_BENEFICIOS_APLICABLES_EN_PROGRAMAS_DE_POSGRADOS_PARA_EGRESADOS: 1889,
    SELECCIONE_LOS_POSGRADOS_DE_SU_INTERS_Y_EN_LOS_CUALES_DESEA_OBTENER_INFORMACIN: 1890,
  },
